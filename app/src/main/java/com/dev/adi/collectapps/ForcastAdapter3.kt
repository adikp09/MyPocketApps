...
class ForcastAdapter3(val list: MutableList<Lists>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForcastAdapter3.ViewHolder {
